...
impl NotificationProps {
    ...
    pub fn variant(mut self, v: NotificationVariant) -> Self {
        self.variant = v;
        self
    }
    ...
    pub fn render(props: NotificationProps) -> Element {
        ...
        Element::Template(Template::new_element(
            ...
            vec![
                ...
                (
                    "class".to_string(),
                    format!("rye-notification {}", props.class.as_deref().unwrap_or("")),
                ),
            ],
            Vec::new(),
            children,
