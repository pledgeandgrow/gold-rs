...
impl StatTrend {
    pub fn icon(&self) -> &'static str {
        match self { Self::Up => "↑", Self::Down => "↓", Self::Neutral => "→" }
    }
    pub fn color(&self) -> &'static str {
        match self { Self::Up => vars::SUCCESS, Self::Down => vars::DANGER, Self::Neutral => vars::TEXT_MUTED }
    }
}
...
impl Default for StatProps {
    fn default() -> Self {
        Self { label: String::new(), value: String::new(), trend: StatTrend::Neutral,
               trend_value: None, icon: None, class: None, style: None }
    }
}
...
impl StatProps {
    ...
    pub fn trend(mut self, t: StatTrend) -> Self { self.trend = t; self }
    pub fn trend_value(mut self, tv: impl Into<String>) -> Self { self.trend_value = Some(tv.into()); self }
...
impl Stat {
    pub fn render(props: StatProps) -> Element {
        ...
        if let Some(icon) = &props.icon {
            top_children.push(Template::new_element("span",
            ...
            children.push(Template::new_element("div",
                ...
                Vec::new(), vec![
                    Template::new_element("span",
                        ...
                        Vec::new(), vec![Template::text(props.trend.icon())]),
                    Template::text(tv),
                ]));
        }
        ...
        Element::Template(Template::new_element("div",
            vec![("style".to_string(), style),
                 ("class".to_string(), format!("rye-stat {}", props.class.as_deref().unwrap_or("")))],
            Vec::new(), children))
    }
}
...
mod tests {
    ...
    #[test]
    fn test_stat_render() {
        let el = Stat::render(StatProps::default().label("Users").value("1,234").trend(StatTrend::Up).trend_value("+8%"));
