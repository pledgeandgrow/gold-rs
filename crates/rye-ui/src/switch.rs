...
impl SwitchProps {
    ...
    pub fn size(mut self, s: SwitchSize) -> Self {
        self.size = s;
        self
    }
}
...
impl Switch {
    pub fn render(props: SwitchProps) -> Element {
        ...
        let track_children = vec![Template::new_element(
            "span",
            vec![("style".to_string(), knob_style)],
            Vec::new(),
            Vec::new(),
        )];
        ...
        let mut input_attrs = vec![
            ...
            (
                "class".to_string(),
                format!("rye-switch-input {}", props.class.as_deref().unwrap_or("")),
            ),
        ];
        if props.checked {
        ...
        let mut label_children = vec![
            Template::new_element(
                ...
                vec![
                    ...
                    ("class".to_string(), "rye-switch-track".to_string()),
                ],
                Vec::new(),
                track_children,
            ),
        ...
        let final_style = if let Some(extra) = &props.style {
        ...
        Element::Template(Template::new_element(
            "label",
            vec![
                ("style".to_string(), final_style),
                ("class".to_string(), "rye-switch".to_string()),
            ],
            Vec::new(),
            label_children,
        ))
