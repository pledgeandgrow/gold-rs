...
impl DialogProps {
    ...
    pub fn close_on_backdrop(mut self, c: bool) -> Self {
        self.close_on_backdrop = c;
        self
    }
}
...
impl Dialog {
    pub fn render(props: DialogProps) -> Element {
        ...
        children.push(Template::new_element(
            "div",
            vec![
                ("class".to_string(), "rye-dialog-body".to_string()),
        ...
        let modal = Template::new_element(
            ...
            vec![
                (
                    "class".to_string(),
                    format!("rye-dialog {}", props.class.as_deref().unwrap_or("")),
                ),
        ...
        Element::Template(Template::new_element(
            "div",
            vec![
                ("class".to_string(), "rye-dialog-backdrop".to_string()),
